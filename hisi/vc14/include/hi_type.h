...
#ifdef _WIN32
typedef unsigned long long      HI_UL;
#else
typedef unsigned long           HI_UL;
#endif
typedef HI_U32                  HI_HANDLE;

typedef HI_U32                  HI_PHYS_ADDR_T;
typedef HI_U32                  HI_VIRT_ADDR_T;
/*----------------------------------------------*
 * Constant Definition                          *
 * CNcomment: 常量定义  CNend                   *
 *----------------------------------------------*/
typedef enum
{
    HI_FALSE    = 0,
...
#ifndef HI_RT_INVALID_HANDLE
#define HI_RT_INVALID_HANDLE (0xffffffff)
#endif
